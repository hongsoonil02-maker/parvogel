...
{tags} (3/3)"""
    ...
    def _format_naver_blog(self, n: Dict[str, Any]) -> Dict[str, Any]:
        ...
        post_content = f"""# [{badge}] {n.get('headline')}

안녕하세요, 반려동물 건강 수호 파트너입니다.
오늘은 **{l1}**, **{l2}**, **{l3}** 기적의 실화를 전해드립니다.

생후 55일령 초소형 아기 강아지(0.6kg)가 급성 장염과 전신 발작 증세로 동물병원에 긴급 내원하여, 단 7일 만에 기적처럼 완치되어 네 발로 뛰어 퇴원한 실제 임상 치료 사례입니다.
...
> **하남 사랑동물병원 김동준 원장님의 임상 소견:**
> "내원 당시 환축은 옆으로 쓰러져 전신 경련(Seizure)을 보이며 안락사까지 고려해야 할 만큼 극도로 위험한 상태였습니다. 첫 48시간 동안 기타 수액이나 약물을 일체 배제하고 오직 파보겔 단독 급여만으로 장 점막 안정과 활력 회복을 이끌어냈습니다."
