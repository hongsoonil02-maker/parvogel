...
const ParvogelLanding = () => {
    ...
    const features = [
        {
            icon: '🧬',
            title: '광범위 항바이러스',
            desc: '로타바이러스, 코로나바이러스, 파보바이러스 등 주요 장염 바이러스 광범위 억제',
            color: 'primary',
        },
        {
            icon: '🛡️',
        ...
        },
        {
            icon: '📦',
            title: '다양한 포장 단위',
            desc: '50ml(개별), 500ml(농장용), 1L(대용량) - 용도별 맞춤 공급',
            color: 'accent',
        },
    ]
    ...
    const products = [
        { id: 'parvogel-50ml', name: '파보겔 50ml', desc: '개별 투약용 / 초보 축주 추천', price: '18,000원', unit: '1병', badge: '인기' },
        { id: 'parvogel-500ml', name: '파보겔 500ml', desc: '농장 상비약 / 경제적 대용량', price: '120,000원', unit: '1병', badge: '베스트' },
        { id: 'parvogel-1l', name: '파보겔 1L', desc: '대규모 농장 / 도매 공급', price: '220,000원', unit: '1병', badge: '대용량' },
    ]
                ...
                <div className="section-container relative z-10 py-20">
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur border border-gray-200 shadow-lg mb-6 animate-fade-in-up">
                            ...
                            <span className="text-sm font-semibold text-gray-700">전축종 신생아 설사 치료제 · 온라인 공식 판매처</span>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        <div>
                            ...
                            <p className="section-subtitle">
                                ...
                                경구용 설사 치료제입니다. 신생아 동물이 초유를 충분히 섭취하지 못했거나,
            ...
            <section id="features" className="py-20 sm:py-28 lg:py-32 bg-gray-50">
                <div className="section-container">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="section-subtitle">
                            수의사·축산농가·약국 현장의 목소리를 반영해 개발된 차세대 신생아 설사 치료제
                        </p>
                    </div>
                ...
                <div className="section-container">
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="tel:1588-0000" className="hover:text-white transition-colors">고객센터: 1588-0000</a></li>
                    ...
                    <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className="text-gray-500 text-sm">
                            © 2025 파보겔 (Parvogel). All rights reserved. | 동물용의약품 제조허가 제○○호
                        </p>
