...
export default function FAQ() {
  ...
  const faqs = [
    ...
    {
      q: t('faq.q6', '앵무새나 조류(반려조), 소형 동물에게도 급여해도 되나요?'),
      a: t('faq.a6', '네, 매우 안전하게 급여하실 수 있습니다. 파보겔의 주원료인 천연 몬모릴로나이트는 화학 약물이 아닌 순수 점토 광물로, 체내로 흡수되지 않고 소화관 내벽을 물리적으로 코팅하며 유해 독소를 흡착해 배출합니다. 체구가 작고 대사가 빠른 앵무새나 반려조의 경우, 설사 발병 시 1회 1~2방울(약 0.1~0.2ml)을 부리 끝에 살짝 묻혀주시거나 이유식/물에 소량 섞어 급여하시면 간이나 신장 부담 없이 빠르고 안전하게 변을 정상화하는 데 큰 도움이 됩니다.'),
      badge: '조류/앵무새'
    }
  ];
